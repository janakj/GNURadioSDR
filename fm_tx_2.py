...
# Title: Fm Tx 2
# Generated: Mon Jun  4 11:14:54 2018
##################################################
...
class fm_tx_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Fm Tx 2")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Fm Tx 2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "fm_tx_2")
...
def main(top_block_cls=fm_tx_2, options=None):
