...
# Generated: Fri Aug  3 00:49:01 2018
##################################################
...
class p25_c4fm_demodulator_ff(gr.hier_block2):
    ...
    def __init__(self, input_rate=48000, output_rate=4800):
        ...
        # Blocks
        ##################################################
        self.symbol_filter = filter.fir_filter_fff(1, (p25.generate_c4fm_taps(output_rate, input_rate, span=9, tx=False)))
        self.symbol_filter.declare_sample_delay(0)
        ...
        self.connect((self, 0), (self.symbol_filter, 0))
        self.connect((self.symbol_filter, 0), (self.op25_fsk4_demod_ff_0, 0))
    ...
    def set_input_rate(self, input_rate):
        self.input_rate = input_rate
        self.symbol_filter.set_taps((p25.generate_c4fm_taps(self.output_rate, self.input_rate, span=9, tx=False)))
